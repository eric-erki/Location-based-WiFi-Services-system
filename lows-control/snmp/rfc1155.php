...
class rfc1155_Boolean extends rfc1155_Asn1Object
{
  ...
  * @param boolean $value
  */
  function rfc1155_Boolean($value=true)
  {
  ...
  */
  function decodeContents($stream)
  {
    if(strlen($stream) != 1)
    {
      trigger_error('Invalid stream length in ' . get_class($this), E_USER_WARNING);
    }
    $this->value = ord($stream{0}) ? true : false;
    return $this;
  }
}
...
class rfc1155_Integer extends rfc1155_Asn1Object
{
  ...
  * @param integer $max
  */
  function check_range($value, $min=NULL, $max=NULL)
  {
