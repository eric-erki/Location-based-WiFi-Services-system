...
class rfc3412_Message extends rfc1155_Sequence
{
  ...
  */
  function rfc3412_Message($version=SNMP_VERSION_3, $header=NULL, $usm_security=NULL, $scopedpdu=NULL)
  {
  ...
  * @return rfc3414_USM
  */
  function usm_security($value=NULL)
  {
...
class rfc3412_Header extends rfc1155_Sequence
{
  ...
  */
  function rfc3412_Header($msgid=0, $max_size=65507, $flags=SNMP_NOAUTH_NOPRIV, $security=SNMP_SECURITY_USM)
  {
    parent::rfc1155_Sequence();
  ...
  * @return boolean
  */
  function reportable_flag($value=NULL)
  {
    if(!is_null($value))
    {
      if($value)
...
class rfc3412_ScopedPDU extends rfc1155_Sequence
{
  ...
  */
  function rfc3412_ScopedPDU($engineid='', $name='', $pdu=NULL)
  {
    parent::rfc1155_Sequence();
