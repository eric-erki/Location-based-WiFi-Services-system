...
class rfc3414_USM extends rfc1155_Sequence
{
  ...
  */
  function rfc3414_USM($engine_id='', $engine_boots=0, $engine_time=0, $user='', $auth='', $priv='')
  {
  ...
  * @return integer
  */
  function engineBoots($value=NULL)
  {
  ...
  * @return integer
  */
  function engineTime($value=NULL)
  {
  ...
  */
  function generate_key($password)
  {
    ...
    if(!strlen($password))
    {
      trigger_error('Zero length password.', E_USER_WARNING);
      $password = chr(255);
    }
